...
public class Ordering extends JFrame {
	...
	public Ordering() {
		...
		lblError.setBounds(172, 169, 148, 16);
		...
		btnClear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				while (coffeeTable.getRowCount() > 0) {
					coffeeTable.removeRow(0);
				}
			}
		});
		btnClear.setBorderPainted(false);
		btnClear.setOpaque(true);
		btnClear.setBackground(new Color(170, 255, 198));
		btnClear.setFont(new Font("Microsoft Sans Serif", Font.PLAIN, 14));
		btnClear.setBounds(35, 345, 117, 29);
	...
	private void addCoffee() {
		...
		if (coffeeQuantity > 0) {
			...
			coffeeTable = (DefaultTableModel)tblOrders.getModel();
			...
			lblError.setText("Enter a Positive Number");
		}

		} catch (Exception e) {
			lblError.setText("Enter a Proper Number");
		}
